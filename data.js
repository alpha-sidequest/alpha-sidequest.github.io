// ============================================
// RAAF Knowledge Hub - Data Layer
// ============================================
// This file contains all the content (bases, aircraft, operations).
// You can safely edit text, numbers, and add new entries here.
// The website will pick up the changes when you reload.
//
// How to add a new aircraft later:
// 1. Copy an existing aircraft object
// 2. Change the id, desig, name, etc.
// 3. Add it inside the AIRCRAFT array (before the closing ])
...
// ---------- MASTER GLOSSARY ----------
// High-value acronyms and terms for defence interviews.
// Every entry includes a crisp definition + "Why it matters" for interview context.
const GLOSSARY = [
  ...
  { term: "P-8A", full: "P-8A Poseidon", category: "platforms", definition: "RAAF's maritime patrol and anti-submarine warfare aircraft based on the Boeing 737. Operated by No. 11 and 12 Squadrons at Edinburgh.", whyItMatters: "The backbone of Australia's maritime ISR and ASW capability. Almost every maritime interview question will reference the P-8A." },
  ...
  { term: "Mission Command", full: "Mission Command", category: "doctrine", definition: "A command philosophy that emphasises decentralised execution based on clear intent, allowing subordinates maximum freedom of action within the commander's intent.", whyItMatters: "One of the 10 ADF Leadership Principles and a core part of ADF-P-0. Interviewers frequently ask for examples of mission command in practice." },
  ...
  { term: "Ghost Bat", full: "MQ-28A Ghost Bat", category: "platforms", definition: "Australia's loyal wingman collaborative combat aircraft (CCA) designed to team with crewed fighters.", whyItMatters: "A sovereign Australian capability and a window into the future of air combat. Frequently discussed in interviews." },
...
// (PFA data removed — prep content moved to dedicated interview-prep site)


// (Ranks study data removed — prep content moved to dedicated site)


// (Leadership and Cyberspace study/prep data removed — content moved to dedicated interview-prep site)
